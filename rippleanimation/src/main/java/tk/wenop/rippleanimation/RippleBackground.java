package tk.wenop.rippleanimation;
...
public class RippleBackground extends RelativeLayout{
    ...
    private static final int DEFAULT_REPEAT_COUNT=ObjectAnimator.INFINITE;
    ...
    public int getRippleRepeatCount() {
        return rippleRepeatCount;
    }

    public void setRippleRepeatCount(int rippleRepeatCount) {
        this.rippleRepeatCount = rippleRepeatCount;
    }
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        // wenop-add
        rippleRepeatCount = DEFAULT_REPEAT_COUNT;
        typedArray.recycle();
    ...
    public void reloadAnimator() {
        ...
        for(int i=0;i<rippleAmount;i++){
            ...
            scaleXAnimator.setRepeatCount(rippleRepeatCount);
            scaleXAnimator.setRepeatMode(ObjectAnimator.RESTART);
            scaleXAnimator.setStartDelay(i * rippleDelay);
            scaleXAnimator.setDuration(rippleDurationTime);
            animatorList.add(scaleXAnimator);
            final ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(rippleView, "ScaleY", 1.0f, rippleScale);
            scaleYAnimator.setRepeatCount(rippleRepeatCount);
            scaleYAnimator.setRepeatMode(ObjectAnimator.RESTART);
            scaleYAnimator.setStartDelay(i * rippleDelay);
            scaleYAnimator.setDuration(rippleDurationTime);
            animatorList.add(scaleYAnimator);
            final ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(rippleView, "Alpha", 1.0f, 0f);
            alphaAnimator.setRepeatCount(rippleRepeatCount);
    ...
    public void startRippleAnimation(){
        // wenop-mod : make this always true, so that we can start a new Ani without
        //      breaking a previous one out.

        if(true || !isRippleAnimationRunning()){
